...
struct User: Codable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, username, bio, website, twitter
...
struct Stem: Codable, Identifiable {
    let id: String
    let title: String
    let slug: String
...
struct Find: Codable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, url, title, description, note, quote
...
struct StemNotification: Codable, Identifiable {
    let id: String
    let type: String
    let actorId: String?
    let stemId: String?
